...
// double Aridge_multi, double ptf_st, double ptf_end, double etaf_st, double etaf_end, double etacms_st, double etacms_end, double etaatlas_st, double etaatlas_end, double phif_st, double phif_end, int n, int check2, double ptjetcut, double q, double Multi){
    ...
    thread t01(func2, Aridge_q[ 0], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 0.80, 95.);   //1D phi correlation, pt = 0.5~5 q = 0.80
    thread t02(func2, Aridge_q[ 1], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 0.85, 95.);   //1D phi correlation, pt = 0.5~5 q = 0.85
    thread t03(func2, Aridge_q[ 2], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 0.90, 95.);   //1D phi correlation, pt = 0.5~5 q = 0.90
    thread t04(func2, Aridge_q[ 3], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 0.95, 95.);   //1D phi correlation, pt = 0.5~5 q = 0.95
    thread t05(func2, Aridge_q[ 4], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.00, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.00
    thread t06(func2, Aridge_q[ 5], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.05, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.05
    thread t07(func2, Aridge_q[ 6], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.10, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.10
    thread t08(func2, Aridge_q[ 7], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.15, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.15
    thread t09(func2, Aridge_q[ 8], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.20, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.20
    thread t10(func2, Aridge_q[ 9], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.25, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.25
    thread t11(func2, Aridge_q[10], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.30, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.30
    thread t12(func2, Aridge_q[11], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.35, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.35 
    thread t13(func2, Aridge_q[12], .5, 5., 1.6, 1.8, 2., 4., 2., 5., -1., 1., 300, 1, 0., 1.40, 95.);   //1D phi correlation, pt = 0.5~5 q = 1.40
